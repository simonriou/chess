...
def normalize_eval(eval_cp, max_cp=12000, mate_score=100000):
    """
    Maps centipawn and mate scores to the range [-10.0, 10.0].
    - Centipawn scores are scaled linearly to [-9, 9]
    - Mate scores (+/- 100000) are mapped to +/- 10.0
    """
    if eval_cp >= 1.0:
        return 10.0
    elif eval_cp <= -1.0:
